...
/差不多得了 数学 数学壬 数学文化 数学壬 数学界`,
  ...
  可以骗: {
    argc: 1,
    template: a => `骗${a[0]}可以，别把你自己也骗到了就行。${a[0]}被你骗了真无所谓的，打个哈哈就过了。但希望你打完这段话后擦一下眼角，别让眼泪掉在手机屏幕上了就行。你说的这些话，${a[0]}信一下也是没什么的。还能让你有个心里安慰，但这种话说出来骗骗兄弟就差不多得了，${a[0]}信你一下也不会少块肉，但是你别搞得自己也当真了就行。${a[0]}被你骗一下是真无所谓的，兄弟笑笑也就过去了。真不是${a[0]}想要破你防，你擦擦眼泪好好想想，除了兄弟谁还会信你这些话?`,
    help: `用法:
/可以骗 名字
如:
/可以骗 哥们`,
